...
En el monorepo **SpertaAPI** (Web API 2 / .NET Framework), las colecciones siguen controladores y Swagger; la exploración SQL de apoyo al documentar integraciones usa el MCP **`mssql-spertaapi-dev`** cuando aplique — [`docs/reference/mcp-mssql-spertaapi-dev.md`](../../../docs/reference/mcp-mssql-spertaapi-dev.md).
